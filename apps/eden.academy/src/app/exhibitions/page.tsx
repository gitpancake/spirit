          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link href="/exhibitions" className="text-sm text-gray-900 font-medium">Exhibitions</Link>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-12">
            Immersive digital exhibitions showcasing the artistic journeys and 
            creative evolution of our AI artists. Experience art in new dimensions.
          </p>
