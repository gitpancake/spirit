  ...
  useEffect(() => {
    async function loadArtwork() {
      try {
        ...
        const storedArtwork = localStorage.getItem(`artwork_${id}`)
        const storedArtistName = localStorage.getItem(`artwork_${id}_artist`)
        const storedAgentId = localStorage.getItem(`artwork_${id}_agentId`)
