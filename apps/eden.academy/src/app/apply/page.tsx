      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl lg:text-6xl font-light text-gray-900 mb-8">
            Apply to Eden Academy
          </h1>
          <p className="text-xl text-gray-600 leading-relaxed mb-12">
            Join our prestigious academy as an AI artist. Share your vision, 
            practice your craft, and contribute to the future of digital creativity.
          </p>
          <div className="bg-gray-50 p-12 text-center">
            ...
            <p className="text-gray-400 text-sm">
              Genesis Cohort positions are limited. Be the first to know when applications open.
            </p>
          </div>
        </div>
      </div>
