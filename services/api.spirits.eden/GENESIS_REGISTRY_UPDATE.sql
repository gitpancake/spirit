-- =============================================
-- GENESIS REGISTRY UPDATE SQL
-- Run this to add new fields for Genesis Registry form
-- =============================================

-- Add new columns for Genesis Registry form fields
...
-- Add check constraint for schedule field
ALTER TABLE agent_applications 
...
-- Update existing applications to have backwards compatibility
